...
export const OPTIONAL_EQUIPMENT = {
  '4WD': '4WD',
  ABS: 'ABS',
  ADAPTIVE_CRUISE_CONTROL: 'ADAPTIVE_CURISE_CONTROL',
  AIR_CONDITIONING: 'AID_CONDITIONING',
  AUTOMATIC_CLIMATE_CONTROL: 'AUTOMATIC_CLIMATE_CONTROL',
  CRUISE_CONTROL: 'CRUISE_CONTROL',
  LED_HEADLIGHTS: 'LED_HEADLIGHTS',
  MULTI_FUNCTION_STEERING_WHEEL: 'MULTI_FUNCTION_STEERING_WHEEL',
...
export const UPHOLSTERY = {
  ALCANTARA: 'ALCANTARA',
  CLOTH: 'CLOTH',
  FULL_LEATHER: 'FULL_LEATHER',
  PART_LEATHER: 'PART_LEATHER',
  VELOUR: 'VELOUR',
  OTHER: 'OTHER',
} as const;

export const EURO_EMISSION_CLASS = {
  EURO_1: 'EURO_1',
  EURO_2: 'EURO_2',
  EURO_3: 'EURO_3',
  EURO_4: 'EURO_4',
